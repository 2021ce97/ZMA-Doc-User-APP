...
export const translations: Translations = {
  ...
  search_placeholder: {
    en: "Search doctors, hospitals...",
    da: "جستجوی داکتر، شفاخانه یا بیماری...",
    ps: "ډاکټر، روغتون یا نښې وپلټئ...",
  },
  ...
  timings_locations: {
    en: "Timings & Locations",
    da: "اوقات کاری و موقعیت‌ها",
    ps: "کاري وختونه او موقعیتونه",
  },

  // New Additions:
  see_all: { en: "See All", da: "مشاهده همه", ps: "ټول وګورئ" },
  ai_desc: {
    en: "Check symptoms for free in multiple languages.",
    da: "بررسی علایم بیماری به زبان‌های دری و پشتو به صورت رایگان.",
    ps: "په وړیا توګه په پښتو او دري ژبو کې نښې وڅیړئ.",
  },
  ...
  main_clinic_location: {
    en: "Main Clinic Location",
    da: "موقعیت معاینه‌خانه اصلی",
    ps: "د اصلي کلینیک موقعیت",
  },
  next_appointment: { en: "Next Token", da: "نوبت بعدی", ps: "راتلونکی نوبت" },
  medical_records: {
    en: "Medical Records",
    da: "سوابق صحی (نسخه‌ها)",
    ps: "طبي ریکارډونه",
  },
  notifications: { en: "Notifications", da: "آگاه‌سازی‌ها", ps: "خبرتیاوې" },
  privacy_security: {
    en: "Privacy & Security",
    da: "حریم خصوصی و امنیت",
    ps: "محرمیت او امنیت",
  },
  logout: { en: "Logout", da: "خروج از حساب", ps: "له حساب څخه وتل" },
  no_favorites: {
    en: "No Favorite Doctors Yet",
    da: "شما هنوز لیست علاقه‌مندی ندارید",
    ps: "تاسو لاهم د خوښې ډاکټر نلرئ",
  },
  favorites_desc: {
    en: "Add trusted doctors to this list for quicker access.",
    da: "برای دسترسی سریعتر به داکتران معتمد خود، آنها را به این لیست اضافه کنید.",
    ps: "د ګړندي لاسرسي لپاره پدې لیست کې باوري ډاکټران اضافه کړئ.",
  },
  ...
  no_upcoming: {
    ...
    da: "شما هیچ نوبت پیش‌رو ندارید",
    ps: "تاسو هیڅ راتلونکی نوبت نلرئ",
  },
  history_empty: {
    en: "Appointment history is empty",
    da: "تاریخچه نوبت‌ها خالی است",
    ps: "د نوبتونو تاریخچه خالي ده",
  },
  no_cancelled: {
    en: "No cancelled appointments",
    da: "نوبت لغو شده‌ای یافت نشد",
    ps: "هیڅ لغوه شوی نوبت ونه موندل شو",
  },
  upcoming_empty_desc: {
    en: "Your upcoming schedule is clear. Book a new appointment.",
    da: "برنامه ملاقات آینده شما خالی است. میتوانید از بخش جستجو داکتر جدید پیدا کنید.",
    ps: "ستاسو راتلونکی مهالویش خالي دی. نوی نوبت ونیسئ.",
  },
  completed_empty_desc: {
    en: "Check other status tabs for past records.",
    da: "برای مشاهده لیست، وضعیت‌های دیگر را بررسی کنید.",
    ps: "د تیرو ریکارډونو لپاره د نورو حالت ټبونه چیک کړئ.",
  },
  ...
  no_results: {
    en: "No results found.",
    da: "نتیجه‌ای یافت نشد.",
    ps: "هیڅ پایله ونه موندل شوه.",
  },
  chat_placeholder: {
    en: "Message AI Assistant...",
    da: "پیام خود را بنویسید...",
    ps: "خپل پیغام ولیکئ...",
  },
  ...
  blog_settings: {
    en: "New Blog Articles",
    da: "مقالات جدید بلاگ",
    ps: "د بلاګ نوې مقالې",
  },
  ai_settings: {
    en: "AI Messages",
    da: "پیام‌های هوش مصنوعی",
    ps: "د AI پیغامونه",
  },
  offline_banner: {
    en: "You are offline (Cached data available)",
    da: "شما آفلاین هستید (دسترسی به اطلاعات ذخیره شده)",
    ps: "تاسو آفلاین یاست (خوندي شوي معلومات شتون لري)",
  },
  onboarding_title: {
    en: "Welcome to our App",
    da: "به اپلیکیشن ما خوش آمدید",
    ps: "زموږ کاریال ته ښه راغلاست",
  },
  onboarding_desc: {
    en: "Find the best doctors, book appointments easily, and use our AI health assistant in Dari and Pashto.",
    da: "بهترین داکتران را پیدا کنید، به راحتی نوبت بگیرید و از دستیار هوشمند صحی ما به زبان‌های دری و پشتو استفاده کنید.",
    ps: "غوره ډاکټران ومومئ، په اسانۍ سره نوبت ونیسئ او زموږ روغتیایی AI مرستیال په پښتو او دري کې وکاروئ.",
  },
  onboarding_start: { en: "Get Started", da: "شروع کنید", ps: "پیل کړئ" },
  dark_mode: {
    en: "Dark Mode",
    da: "حالت تاریک (Dark Mode)",
    ps: "تیاره حالت (Dark Mode)",
  },
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <LanguageContext.Provider
      value={{ lang, setLang, t, isRtl: lang === "da" || lang === "ps" }}
    >
      {children}
    </LanguageContext.Provider>
  );
