export const DOCTORS = [
  {
    ...
    about:
      "دکتر احمد نوری متخصص بیماری‌های قلبی و عروقی فارغ‌التحصیل از پوهنتون کابل با ۱۲ سال تجربه کاری در شفاخانه‌های دولتی و خصوصی.",
    affiliations: ["شفاخانه بین‌المللی کابل", "کلینیک قلب شهر نو"],
    timings: [
      {
        day: "شنبه تا چهارشنبه",
        hours: "۸:۰۰ صبح - ۴:۰۰ عصر",
        clinic: "شفاخانه بین‌المللی کابل",
      },
      {
        day: "پنجشنبه",
        hours: "۲:۰۰ عصر - ۸:۰۰ شب",
        clinic: "کلینیک قلب شهر نو",
      },
    ],
    city: "کابل",
  ...
  },
  {
    ...
    about:
      "دکتر مریم سادات متخصص نسائی ولادی با تجربه طولانی در بخش مراقبت‌های مادر و کودک.",
    affiliations: ["کلینیک تخصصی مادر", "شفاخانه حوزوی بلخ"],
    timings: [
      {
        day: "هر روز بجز جمعه",
        hours: "۹:۰۰ صبح - ۱:۰۰ عصر",
        clinic: "کلینیک تخصصی مادر",
      },
      {
        day: "دوشنبه و چهارشنبه",
        hours: "۴:۰۰ عصر - ۷:۰۰ شب",
        clinic: "شفاخانه حوزوی بلخ",
      },
    ],
    city: "مزارشریف",
  ...
  },
  {
    ...
    about:
      "داکتر عمومی برای تداوی امراض داخله، مشاوره صحی و رهنمایی مریضان به متخصصین.",
    affiliations: ["شفاخانه حوزوی هرات"],
    timings: [
      {
        day: "تمام روزهای هفته",
        hours: "۲:۰۰ عصر - ۱۰:۰۰ شب",
        clinic: "شفاخانه حوزوی هرات",
      },
    ],
    city: "هرات",
  ...
  },
  {
    ...
    about:
      "متخصص امراض اطفال، واکسیناسیون و تغذیه سالم برای کودکان از بدو تولد تا ۱۸ سالگی.",
    affiliations: ["شفاخانه اطفال آتاترک", "پلی کلینیک شفا"],
    timings: [
      {
        day: "یکشنبه تا پنجشنبه",
        hours: "۸:۰۰ صبح - ۲:۰۰ عصر",
        clinic: "شفاخانه اطفال آتاترک",
      },
      {
        day: "پنجشنبه و جمعه",
        hours: "۴:۰۰ عصر - ۸:۰۰ شب",
        clinic: "پلی کلینیک شفا",
      },
    ],
    city: "کابل",
