export const DOCTORS = [
  {
    ...
    skills: ['اکوکاردیوگرافی', 'آنژیوگرافی', 'تست ورزش قلب'],
    onlineBooking: true
  },
  {
    id: 'd2',
    ...
    skills: ['سونوگرافی زنان', 'جراحی کیست', 'مراقبت‌های دوران بارداری'],
    onlineBooking: false
  },
  {
    id: 'd3',
    ...
    skills: ['مدیریت دیابت', 'تشخیص اولیه بیماری‌ها'],
    onlineBooking: true
  },
  {
    id: 'd4',
    ...
    skills: ['واکسیناسیون', 'درمان سوء تغذیه', 'مشاوره رشد طفل'],
    onlineBooking: false
  }
];
